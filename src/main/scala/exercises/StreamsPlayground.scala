...
object StreamsPlayground extends App {
  ...
  // println(startFrom0.filter(_ < 10).take(11).toList()) // crashes will try to find 11th element to match predicate infintely
  ...
  */
  ...
  /*
    ...
    [ 2 3 5 7 9 11 13 ...
    [ eratosthenes applied to (numbers filtered by n % 2 != 0)
